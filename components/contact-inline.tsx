  ...
  return (
    <section className="container max-w-6xl">
      <h2 className="mb-8 font-heading text-2xl font-bold">
        <span className="font-mono text-sm font-normal text-muted-foreground/40">{"//"}</span> contact
      </h2>
      <div className="rounded-xl border border-border/50 bg-background/60 p-8 text-center backdrop-blur-xl sm:p-12">
        <h3 className="font-heading text-xl font-bold">Let&apos;s build something</h3>
